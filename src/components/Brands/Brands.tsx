    ...
    return (
        <section className='brands modified-brand-section'>
            ...
            <div className='brand_arrows'>
                {idatual !== 0 ? (
                    <div className='brand_arrow_left' onClick={() => { if (idatual > 0) { setIdatual(idatual - 1) } }}>
                ...
                {idatual + 1 < maxid ? (
                    <div className='brand_arrow_rigth' onClick={() => { if (idatual + 1 < maxid) { setIdatual(idatual + 1) } }}>
